...
df = pd.read_csv(settings.MEDIA_ROOT + "/internet_cleaned.csv")
df = df[df['year'] == 2019]
...
# -------------------------------------------------------------------------------------
# App layout
app = DjangoDash('bardash01', external_stylesheets=external_stylesheets)
...
>>>> 2o gráfico (mapa) comentei para não atrapalhar o layout do modelo que fiz
